...
const AddItems = () => {
    ...
    return (
        ...
        <Button className=" rounded-lg  mt-4" type="submit">Add Item <FaUtensils className="ml-2"></FaUtensils></Button>
            </form>
        </div>
    );
};
